...
class ook-demodulator-AGC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ook-demodulator-AGC")
...
def main(top_block_cls=ook-demodulator-AGC, options=None):
